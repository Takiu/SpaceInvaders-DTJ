...
@:keep @:bind #if display private #end class __ASSET__assets_sounds_click_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_force_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_fuite_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_gamestart_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_go_pokeball_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_menu_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_open_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_pokemon_bluered__wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_pokemonbattle_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_sortie_wav extends flash.media.Sound { }
