...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "SpaceInvPkm", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "SpaceInvPkm";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "SpaceInvPkm", null, { width: 480, height: 432 });
